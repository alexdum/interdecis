...
#' @param metrics The indicators to be computed. See Details section with de description of which indicator. The spliting data
#' frame is based on the \code{link[openair]{cutData}} function (\code{link[openair]} package).
